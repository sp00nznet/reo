...
// Function: entry_15ffe0
// Address: 0x15ffe0 - 0x160710
void entry_15ffe0_0x160710(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x15FFC0u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x16000Cu; }
    }
    if (ctx->pc != 0x16000Cu) { return; }
    ctx->pc = 0x16000Cu;
    // 0x16000c: 0x101940
    ctx->pc = 0x16000cu;
...
label_160040:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x160074u; }
    }
    if (ctx->pc != 0x160074u) { return; }
    ctx->pc = 0x160074u;
    // 0x160074: 0x2404fff4
    ctx->pc = 0x160074u;
...
label_160130:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x16015Cu; }
    }
    if (ctx->pc != 0x16015Cu) { return; }
    ctx->pc = 0x16015Cu;
    // 0x16015c: 0x14400008
    ctx->pc = 0x16015Cu;
    {
...
label_160218:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x16023Cu; }
    }
    if (ctx->pc != 0x16023Cu) { return; }
    ctx->pc = 0x16023Cu;
    // 0x16023c: 0x3a0302d
    ctx->pc = 0x16023cu;
...
label_160320:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x160344u; }
    }
    if (ctx->pc != 0x160344u) { return; }
    ctx->pc = 0x160344u;
    // 0x160344: 0x3a0282d
    ctx->pc = 0x160344u;
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
...
label_160374:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1603DCu; }
    }
    if (ctx->pc != 0x1603DCu) { return; }
    ctx->pc = 0x1603DCu;
    // 0x1603dc: 0x3c040024
    ctx->pc = 0x1603dcu;
    SET_GPR_U32(ctx, 4, ((uint32_t)36 << 16));
...
label_16044c:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1604BCu; }
    }
    if (ctx->pc != 0x1604BCu) { return; }
    ctx->pc = 0x1604BCu;
    // 0x1604bc: 0x3c040024
    ctx->pc = 0x1604bcu;
    SET_GPR_U32(ctx, 4, ((uint32_t)36 << 16));
...
label_1604e0:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x16050Cu; }
    }
    if (ctx->pc != 0x16050Cu) { return; }
    ctx->pc = 0x16050Cu;
    // 0x16050c: 0x1440000a
    ctx->pc = 0x16050Cu;
    {
...
label_160538:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x16056Cu; }
    }
    if (ctx->pc != 0x16056Cu) { return; }
    ctx->pc = 0x16056Cu;
    // 0x16056c: 0x220202d
    ctx->pc = 0x16056cu;
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
...
label_1605a0:
    ...
    ctx->pc = 0x15FFC0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_0015FFC0_0x15ffc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1605D4u; }
    }
    if (ctx->pc != 0x1605D4u) { return; }
    ctx->pc = 0x1605D4u;
    // 0x1605d4: 0x200202d
    ctx->pc = 0x1605d4u;
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
