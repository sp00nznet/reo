...
// Function: sub_001BC8B0
// Address: 0x1bc8b0 - 0x1bccb0
...
label_1bc8bc:
    // 0x1bc8bc: 0x8c2344d8
    ctx->pc = 0x1bc8bcu;
    SET_GPR_U32(ctx, 3, READ32(ADD32(GPR_U32(ctx, 1), 17624)));
label_1bc8c0:
    // 0x1bc8c0: 0x14600005
label_1bc8c4:
    if (ctx->pc == 0x1BC8C4u) {
    ...
    ctx->pc = 0x1BC8C0u;
    {
        const bool branch_taken_0x1bc8c0 = (GPR_U32(ctx, 3) != GPR_U32(ctx, 0));
        if (branch_taken_0x1bc8c0) {
            ctx->pc = 0x1BC8D8u;
            goto label_1bc8d8;
        }
    }
...
label_1bc8cc:
    ...
    ctx->pc = 0x1BC8C8u;
    SET_GPR_U32(ctx, 31, 0x1BC8D0u);
    ctx->pc = 0x1F73B0u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_001F73B0_0x1f73b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BC8D0u; }
    }
    if (ctx->pc != 0x1BC8D0u) { return; }
    ctx->pc = 0x1BC8D0u;
label_1bc8d0:
    // 0x1bc8d0: 0x3c010032
    ctx->pc = 0x1bc8d0u;
...
label_1bc8d4:
    // 0x1bc8d4: 0xac2244d8
    ctx->pc = 0x1bc8d4u;
    WRITE32(ADD32(GPR_U32(ctx, 1), 17624), GPR_U32(ctx, 2));
label_1bc8d8:
    // 0x1bc8d8: 0xdfbf0000
    ctx->pc = 0x1bc8d8u;
