...
void sub_001327B8_0x1327b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1327C8u;
    {
        const bool branch_taken_0x1327c8 = (GPR_U32(ctx, 17) != GPR_U32(ctx, 0));
        ctx->pc = 0x1327CCu;
        WRITE64(ADD32(GPR_U32(ctx, 29), 16), GPR_U64(ctx, 31));
        if (branch_taken_0x1327c8) {
            ctx->pc = 0x1327F0u;
            goto label_1327f0;
        }
    }
    ...
    // 0x1327dc: 0x2484b178
    ctx->pc = 0x1327dcu;
    SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 4), 4294947192));
    // 0x1327e0: 0xdfbf0010
    ctx->pc = 0x1327e0u;
...
label_1327f0:
    // 0x1327f0: 0xa6250040
    ctx->pc = 0x1327f0u;
    WRITE16(ADD32(GPR_U32(ctx, 17), 64), (uint16_t)GPR_U32(ctx, 5));
    // 0x1327f4: 0x8e240004
    ctx->pc = 0x1327f4u;
    SET_GPR_U32(ctx, 4, READ32(ADD32(GPR_U32(ctx, 17), 4)));
    // 0x1327f8: 0xc04b63e
    ctx->pc = 0x1327F8u;
    SET_GPR_U32(ctx, 31, 0x132800u);
    ctx->pc = 0x1327FCu;
    ...
    ctx->pc = 0x12D8F8u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x132800u; }
    }
    if (ctx->pc != 0x132800u) { return; }
    ctx->pc = 0x132800u;
    // 0x132800: 0x86250040
    ctx->pc = 0x132800u;
    ...
    SET_GPR_S32(ctx, 29, ADD32(GPR_U32(ctx, 29), 32));
    ctx->pc = 0x12C7F8u;
    sub_0012C7F8_0x12c7f8(rdram, ctx, runtime); return;
    ctx->pc = 0x132820u;
    // 0x132820: 0x27bdfff0
    ctx->pc = 0x132820u;
