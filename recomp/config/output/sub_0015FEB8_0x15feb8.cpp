...
// Function: sub_0015FEB8
// Address: 0x15feb8 - 0x15ffc0
void sub_0015FEB8_0x15feb8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x15FEC0u;
    {
        const bool branch_taken_0x15fec0 = (GPR_U32(ctx, 4) == GPR_U32(ctx, 0));
        ctx->pc = 0x15FEC4u;
...
label_15fecc:
    ...
    ctx->pc = 0x15FEE8u;
    {
        const bool branch_taken_0x15fee8 = (GPR_U32(ctx, 4) == GPR_U32(ctx, 0));
        ctx->pc = 0x15FEECu;
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
...
label_15fef4:
    ...
    SET_GPR_S32(ctx, 29, ADD32(GPR_U32(ctx, 29), 16));
    ctx->pc = 0x175588u;
    sub_00175588_0x175588(rdram, ctx, runtime); return;
    ctx->pc = 0x15FF04u;
    // 0x15ff04: 0x0
    ctx->pc = 0x15ff04u;
    // NOP
