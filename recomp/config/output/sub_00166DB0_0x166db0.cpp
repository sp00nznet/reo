...
// Function: sub_00166DB0
// Address: 0x166db0 - 0x166e68
void sub_00166DB0_0x166db0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x166DB4u;
    {
        const bool branch_taken_0x166db4 = (GPR_U32(ctx, 3) == GPR_U32(ctx, 0));
        ctx->pc = 0x166DB8u;
        SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 0), 4294967295));
        if (branch_taken_0x166db4) {
            ctx->pc = 0x166DECu;
            goto label_166dec;
        }
    }
    ...
    ctx->pc = 0x166DC0u;
    {
        const bool branch_taken_0x166dc0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
        ctx->pc = 0x166DC4u;
    ...
    ctx->pc = 0x166DCCu;
    {
        const bool branch_taken_0x166dcc = (GPR_U32(ctx, 3) == GPR_U32(ctx, 0));
        ctx->pc = 0x166DD0u;
        SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 0), 4294967295));
    ...
    ctx->pc = 0x166DD8u;
    {
        const bool branch_taken_0x166dd8 = (GPR_S32(ctx, 3) <= 0);
    ...
    ctx->pc = 0x166DE4u;
    {
        const bool branch_taken_0x166de4 = (GPR_S32(ctx, 3) <= 0);
        if (branch_taken_0x166de4) {
            ctx->pc = 0x166DE8u;
            SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
            ctx->pc = 0x166DECu;
            goto label_166dec;
