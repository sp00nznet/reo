...
// Function: sub_00104EF0
// Address: 0x104ef0 - 0x1050b0
...
label_104ef8:
    if (ctx->pc == 0x104EF8u) {
        ctx->pc = 0x104EF8u;
        SET_GPR_U32(ctx, 2, READ32(ADD32(GPR_U32(ctx, 3), 4294940656)));
        ctx->pc = 0x104EFCu;
        goto label_104efc;
    }
    ctx->pc = 0x104EF4u;
    {
        ...
        switch (jumpTarget) {
            ...
            case 0x104EF8u: goto label_104ef8;
            case 0x104EFCu: goto label_104efc;
