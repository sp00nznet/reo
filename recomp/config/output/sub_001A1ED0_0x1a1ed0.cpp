...
// Function: sub_001A1ED0
// Address: 0x1a1ed0 - 0x1a2200
void sub_001A1ED0_0x1a1ed0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x1a1ed4: 0x248c000c
    ctx->pc = 0x1a1ed4u;
    SET_GPR_S32(ctx, 12, ADD32(GPR_U32(ctx, 4), 12));
    // 0x1a1ed8: 0x102d
    ctx->pc = 0x1a1ed8u;
    ...
    ctx->pc = 0x1A1EF8u;
    {
        const bool branch_taken_0x1a1ef8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1EFCu;
        SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 0), 34));
        if (branch_taken_0x1a1ef8) {
            ctx->pc = 0x1A1FBCu;
            goto label_1a1fbc;
        }
    }
...
label_1a1f00:
    // 0x1a1f00: 0x8d8d0000
    ctx->pc = 0x1a1f00u;
    SET_GPR_U32(ctx, 13, READ32(ADD32(GPR_U32(ctx, 12), 0)));
    // 0x1a1f04: 0x1a96824
    ctx->pc = 0x1a1f04u;
    SET_GPR_U32(ctx, 13, AND32(GPR_U32(ctx, 13), GPR_U32(ctx, 9)));
    // 0x1a1f08: 0xd6c02
    ctx->pc = 0x1a1f08u;
    SET_GPR_U32(ctx, 13, SRL32(GPR_U32(ctx, 13), 16));
    // 0x1a1f0c: 0x11a80023
    ctx->pc = 0x1A1F0Cu;
    {
        const bool branch_taken_0x1a1f0c = (GPR_U32(ctx, 13) == GPR_U32(ctx, 8));
    ...
    ctx->pc = 0x1A1F14u;
    {
        const bool branch_taken_0x1a1f14 = (GPR_U32(ctx, 13) == GPR_U32(ctx, 7));
        if (branch_taken_0x1a1f14) {
            ctx->pc = 0x1A1F8Cu;
            goto label_1a1f8c;
        }
    }
    ...
    ctx->pc = 0x1A1F1Cu;
    {
        const bool branch_taken_0x1a1f1c = (GPR_U32(ctx, 13) == GPR_U32(ctx, 6));
        if (branch_taken_0x1a1f1c) {
            ctx->pc = 0x1A1F7Cu;
            goto label_1a1f7c;
        }
    }
    ...
    ctx->pc = 0x1A1F24u;
    {
        const bool branch_taken_0x1a1f24 = (GPR_U32(ctx, 13) == GPR_U32(ctx, 5));
    ...
    ctx->pc = 0x1A1F2Cu;
    {
        const bool branch_taken_0x1a1f2c = (GPR_U32(ctx, 13) == GPR_U32(ctx, 4));
        if (branch_taken_0x1a1f2c) {
            ctx->pc = 0x1A1F54u;
            goto label_1a1f54;
        }
    }
    ...
    ctx->pc = 0x1A1F34u;
    {
        const bool branch_taken_0x1a1f34 = (GPR_U32(ctx, 13) == GPR_U32(ctx, 3));
        if (branch_taken_0x1a1f34) {
            ctx->pc = 0x1A1F44u;
            goto label_1a1f44;
        }
    }
    ...
    ctx->pc = 0x1A1F3Cu;
    {
        const bool branch_taken_0x1a1f3c = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F40u;
...
label_1a1f44:
    // 0x1a1f44: 0x8d8d0004
    ctx->pc = 0x1a1f44u;
    SET_GPR_U32(ctx, 13, READ32(ADD32(GPR_U32(ctx, 12), 4)));
    // 0x1a1f48: 0xd68c0
    ctx->pc = 0x1a1f48u;
    ...
    ctx->pc = 0x1A1F4Cu;
    {
        const bool branch_taken_0x1a1f4c = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F50u;
...
label_1a1f54:
    ...
    // 0x1a1f58: 0xd6900
    ctx->pc = 0x1a1f58u;
    SET_GPR_U32(ctx, 13, SLL32(GPR_U32(ctx, 13), 4));
    // 0x1a1f5c: 0x10000014
    ctx->pc = 0x1A1F5Cu;
    {
        const bool branch_taken_0x1a1f5c = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F60u;
        SET_GPR_U32(ctx, 2, ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 13)));
        if (branch_taken_0x1a1f5c) {
            ctx->pc = 0x1A1FB0u;
            goto label_1a1fb0;
        }
    }
...
label_1a1f64:
    // 0x1a1f64: 0x8d8e0004
    ctx->pc = 0x1a1f64u;
    SET_GPR_U32(ctx, 14, READ32(ADD32(GPR_U32(ctx, 12), 4)));
    // 0x1a1f68: 0xe6880
    ctx->pc = 0x1a1f68u;
    SET_GPR_U32(ctx, 13, SLL32(GPR_U32(ctx, 14), 2));
    // 0x1a1f6c: 0x1ae6821
    ctx->pc = 0x1a1f6cu;
    ...
    ctx->pc = 0x1A1F74u;
    {
        const bool branch_taken_0x1a1f74 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F78u;
        SET_GPR_U32(ctx, 2, ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 13)));
        if (branch_taken_0x1a1f74) {
            ctx->pc = 0x1A1FB0u;
            goto label_1a1fb0;
        }
    }
...
label_1a1f7c:
    ...
    ctx->pc = 0x1A1F84u;
    {
        const bool branch_taken_0x1a1f84 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F88u;
        SET_GPR_U32(ctx, 2, ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 13)));
...
label_1a1f8c:
    ...
    ctx->pc = 0x1A1F94u;
    {
        const bool branch_taken_0x1a1f94 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A1F98u;
        SET_GPR_U32(ctx, 2, ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 13)));
        if (branch_taken_0x1a1f94) {
            ctx->pc = 0x1A1FB0u;
            goto label_1a1fb0;
        }
    }
...
label_1a1f9c:
    ...
    // 0x1a1fa0: 0xe6840
    ctx->pc = 0x1a1fa0u;
    SET_GPR_U32(ctx, 13, SLL32(GPR_U32(ctx, 14), 1));
    // 0x1a1fa4: 0x1ae6821
    ctx->pc = 0x1a1fa4u;
    SET_GPR_U32(ctx, 13, ADD32(GPR_U32(ctx, 13), GPR_U32(ctx, 14)));
    // 0x1a1fa8: 0xd6880
...
label_1a1fbc:
    // 0x1a1fbc: 0x14b682a
    ctx->pc = 0x1a1fbcu;
    SET_GPR_U32(ctx, 13, SLT32(GPR_S32(ctx, 10), GPR_S32(ctx, 11)));
    // 0x1a1fc0: 0x15a0ffcf
    ctx->pc = 0x1A1FC0u;
    {
        const bool branch_taken_0x1a1fc0 = (GPR_U32(ctx, 13) != GPR_U32(ctx, 0));
        if (branch_taken_0x1a1fc0) {
            ctx->pc = 0x1A1F00u;
            goto label_1a1f00;
        }
    }
