...
// Function: sub_001249A0
// Address: 0x1249a0 - 0x124cd8
...
label_1249b0:
    ...
    ctx->pc = 0x1249ACu;
    {
        const bool branch_taken_0x1249ac = (GPR_U32(ctx, 16) == GPR_U32(ctx, 0));
        ctx->pc = 0x1249B0u;
        WRITE64(ADD32(GPR_U32(ctx, 29), 8), GPR_U64(ctx, 31));
...
label_1249bc:
    ...
    ctx->pc = 0x1249B8u;
    SET_GPR_U32(ctx, 31, 0x1249C0u);
    ctx->pc = 0x1249BCu;
    WRITE32(ADD32(GPR_U32(ctx, 16), 8), GPR_U32(ctx, 0));
    ctx->pc = 0x134F58u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_00134F58_0x134f58(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1249C0u; }
    }
    if (ctx->pc != 0x1249C0u) { return; }
    ctx->pc = 0x1249C0u;
label_1249c0:
    // 0x1249c0: 0x200202d
    ctx->pc = 0x1249c0u;
...
label_1249cc:
    ...
    ctx->pc = 0x107C68u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1249D0u; }
    }
    if (ctx->pc != 0x1249D0u) { return; }
    ctx->pc = 0x1249D0u;
label_1249d0:
    // 0x1249d0: 0xa6000000
    ctx->pc = 0x1249d0u;
