...
// Function: sub_00125458
// Address: 0x125458 - 0x125518
...
label_125458:
    ...
    ctx->pc = 0x125458u;
    {
        const bool branch_taken_0x125458 = (GPR_S32(ctx, 6) <= 0);
        if (branch_taken_0x125458) {
            ctx->pc = 0x12547Cu;
            goto label_12547c;
        }
    }
...
label_125460:
    ...
    ctx->pc = 0x125474u;
    {
        const bool branch_taken_0x125474 = (GPR_S32(ctx, 6) > 0);
        ctx->pc = 0x125478u;
        SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 4), 2));
        if (branch_taken_0x125474) {
            ctx->pc = 0x125460u;
            goto label_125460;
        }
    }
