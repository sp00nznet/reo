...
// Function: sub_001A2DA0
// Address: 0x1a2da0 - 0x1a2ff0
...
label_1a2da0:
    ...
    ctx->pc = 0x1A2B30u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A2DBCu; }
    }
    if (ctx->pc != 0x1A2DBCu) { return; }
    ctx->pc = 0x1A2DBCu;
    // 0x1a2dbc: 0x202102a
    ctx->pc = 0x1a2dbcu;
    ...
    ctx->pc = 0x1A2DC0u;
    {
        const bool branch_taken_0x1a2dc0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
        ctx->pc = 0x1A2DC4u;
    ...
    ctx->pc = 0x1A2DC8u;
    {
        const bool branch_taken_0x1a2dc8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1A2DCCu;
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        if (branch_taken_0x1a2dc8) {
            ctx->pc = 0x1A2DE0u;
            goto label_1a2de0;
        }
    }
...
label_1a2dd0:
    ...
    ctx->pc = 0x1A2BB0u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A2DD8u; }
    }
    if (ctx->pc != 0x1A2DD8u) { return; }
    ctx->pc = 0x1A2DD8u;
    // 0x1a2dd8: 0x21180
    ctx->pc = 0x1a2dd8u;
