...
// Function: sub_00140E88
// Address: 0x140e88 - 0x141280
...
label_140e94:
    // 0x140e94: 0x24509a74
    ctx->pc = 0x140e94u;
    SET_GPR_S32(ctx, 16, ADD32(GPR_U32(ctx, 2), 4294941300));
label_140e98:
    // 0x140e98: 0xffbf0008
    ctx->pc = 0x140e98u;
...
label_140ea4:
    // 0x140ea4: 0x24639a70
    ctx->pc = 0x140ea4u;
    SET_GPR_S32(ctx, 3, ADD32(GPR_U32(ctx, 3), 4294941296));
label_140ea8:
    // 0x140ea8: 0x8c620000
    ctx->pc = 0x140ea8u;
...
label_140eb0:
    ...
    ctx->pc = 0x140EACu;
    {
        const bool branch_taken_0x140eac = (GPR_U32(ctx, 4) != GPR_U32(ctx, 0));
        ctx->pc = 0x140EB0u;
        SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 4), 1));
...
label_140eb8:
    ...
    ctx->pc = 0x140EB4u;
    SET_GPR_U32(ctx, 31, 0x140EBCu);
    ctx->pc = 0x1392F8u;
    {
        const uint32_t __entryPc = ctx->pc;
        sub_001392F8_0x1392f8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x140EBCu; }
    }
    if (ctx->pc != 0x140EBCu) { return; }
    ctx->pc = 0x140EBCu;
label_140ebc:
    // 0x140ebc: 0x8e040000
    ctx->pc = 0x140ebcu;
